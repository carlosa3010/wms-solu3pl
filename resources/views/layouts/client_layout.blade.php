            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex items-center gap-1">
                        ...
                        <a href="{{ route('client.orders.create') }}" class="px-3 py-2 rounded-lg text-sm font-bold {{ request()->routeIs('client.orders.*') ? 'text-blue-600 bg-blue-50' : 'text-slate-500 hover:bg-slate-50' }}">Pedidos</a>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="p-2 text-slate-400 hover:text-rose-600"><i data-lucide="log-out" class="w-5 h-5"></i></button>
                    </form>
                </div>
            </div>
        </div>
